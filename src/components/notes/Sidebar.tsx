      ...
      {starredItems.length > 0 && (
        <div>
          <button
            ...
            className="w-full flex items-center gap-1 py-0.5 text-[11px] text-[--muted] hover:bg-[--hover]"
            ...
            <div>
              {starredItems.map(item => (
                <button
                  ...
                  className={`w-full flex items-center gap-1.5 py-0.5 text-[11px] text-left hover:bg-[--hover] ${
