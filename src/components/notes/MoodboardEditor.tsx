  ...
  return (
    ...
    >
      <div className={isFullWidth ? "px-4 py-6 md:px-8 md:py-12" : "max-w-4xl mx-auto px-4 py-6 md:px-8 md:py-12"}>
        ...
        {isLoadingUrls && images.length > 0 && imagesWithSignedUrls.every(img => !img.url) ? (
          ...
          <div className="border-2 border-dashed border-[--border] rounded-lg p-12 flex flex-col items-center justify-center">
            <svg className="w-12 h-12 mb-4 text-[--muted] animate-spin" fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
            </svg>
            <p className="text-[--muted] text-sm">Loading images...</p>
          </div>
        ) : images.length === 0 ? (
          <div
