...
Launch revealed many issues. The most vexing: increasing lags during encounters, eventually crashing and losing the game. The problem: instead of dismissing WarpViewVC, the app fired a segue, stacking copies. Dismissing instead of segueing solved it.`}};a.s(["posts",0,b])},66685,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(87839),e=a.i(77929),f=a.i(63672),g=a.i(38246);function h(){let[a,h]=(0,c.useState)(null),[i,j]=(0,c.useState)(!0),[k,l]=(0,c.useState)(""),[m,n]=(0,c.useState)(!1),[o,p]=(0,c.useState)(!1);(0,c.useEffect)(()=>(0,f.onAuthChange)(a=>{a&&(0,f.isAdminEmail)(a.email)?h(a):h(null),j(!1)}),[]);let q=async()=>{n(!0),l("Checking existing posts...");try{let a=await (0,e.getAllPosts)(),b=new Set(a.map(a=>a.slug)),c=Object.values(d.posts).filter(a=>!b.has(a.slug));if(0===c.length){l("All posts already migrated!"),p(!0);return}for(let a of(l(`Migrating ${c.length} posts...`),c)){l(`Migrating: ${a.title}`);let b=a.content;a.images&&a.images.forEach((a,c)=>{b=b.replace(`[IMAGE:${c}]`,`![${a.alt}](${a.src})`)});let c={slug:a.slug,title:a.title,date:a.date||new Date().toISOString().split("T")[0],content:b,status:a.date?"published":"draft"};a.isProject&&(c.isProject=!0),a.parent&&(c.parent=a.parent),await (0,e.createPost)(c)}l(`Successfully migrated ${c.length} posts!`),p(!0)}catch(a){console.error("Migration error:",a),l(`Error: ${a}`)}finally{n(!1)}};return i?(0,b.jsx)("div",{className:"min-h-screen bg-[--background] flex items-center justify-center",children:(0,b.jsx)("p",{className:"text-[--muted]",children:"Loading..."})}):a?(0,b.jsxs)("div",{className:"min-h-screen bg-[--background] flex flex-col items-center justify-center p-8",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-[--foreground] mb-4",children:"Migrate Posts to Firestore"}),(0,b.jsx)("p",{className:"text-[--muted] mb-8 text-center max-w-md",children:"This will copy all hardcoded posts from src/lib/posts.ts to your Firestore database. Existing posts with the same slug will be skipped."}),(0,b.jsxs)("div",{className:"space-y-4 text-center",children:[!o&&(0,b.jsx)("button",{onClick:q,disabled:m,className:"px-6 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50",children:m?"Migrating...":"Start Migration"}),k&&(0,b.jsx)("p",{className:"text-[--foreground]",children:k}),o&&(0,b.jsx)(g.default,{href:"/admin",className:"inline-block px-6 py-3 bg-blue-600 text-white rounded hover:bg-blue-700",children:"Go to Admin →"})]}),(0,b.jsx)(g.default,{href:"/admin",className:"mt-8 text-[--muted] hover:text-[--accent] text-sm",children:"← back to admin"})]}):(0,b.jsxs)("div",{className:"min-h-screen bg-[--background] flex flex-col items-center justify-center p-8",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-[--foreground] mb-4",children:"Migrate Posts to Firestore"}),(0,b.jsx)("p",{className:"text-[--muted] mb-8",children:"Sign in to continue"}),(0,b.jsx)("button",{onClick:()=>(0,f.signInWithGoogle)(),className:"px-6 py-3 bg-blue-600 text-white rounded hover:bg-blue-700",children:"Sign in with Google"}),(0,b.jsx)(g.default,{href:"/admin",className:"mt-8 text-[--muted] hover:text-[--accent] text-sm",children:"← back to admin"})]})}a.s(["default",()=>h])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__7a94a943._.js.map